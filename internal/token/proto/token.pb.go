...
// source: micro/focalsolution/micro-internal/token/proto/token.proto
...
func init() {
	proto.RegisterFile("micro/focalsolution/micro-internal/token/proto/token.proto", fileDescriptor_785746f161be1dd6)
}
