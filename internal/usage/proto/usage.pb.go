...
// source: github.com/focalsolution/micro-micro/internal/usage/proto/usage.proto
...
func init() {
	proto.RegisterFile("github.com/focalsolution/micro-micro/internal/usage/proto/usage.proto", fileDescriptor_usage_7cdccb5f3bba2052)
}
