...
// source: micro/focalsolution/micro-cmd/usage/proto/usage.proto
...
func init() {
	proto.RegisterFile("micro/focalsolution/micro-cmd/usage/proto/usage.proto", fileDescriptor_8a13186c7d202766)
}
